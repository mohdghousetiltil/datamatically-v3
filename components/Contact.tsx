                                ...
                                >
                                    <form className="text-left space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                                        ...
                                        <div className="grid grid-cols-1 gap-4 md:gap-6">
                                            <div>
                                                <label className="block text-[9px] font-bold text-gray-500 mb-2 uppercase tracking-widest font-space">Phone (Optional)</label>
                                                <input type="tel" name="phone" value={formData.phone} onChange={handleChange} className="w-full bg-gray-50 dark:bg-black/50 border border-gray-300 dark:border-gray-700 rounded-xl p-3.5 outline-none text-slate-900 dark:text-white focus:border-blue-600 transition-colors font-space text-sm md:text-base" />
                                            </div>
                                        </div>
                                        <div>
                                            <label className="block text-[9px] font-bold text-gray-500 mb-2 uppercase tracking-widest font-space">Message</label>
                                            <textarea name="message" value={formData.message} onChange={handleChange} rows={4} className="w-full bg-gray-50 dark:bg-black/50 border border-gray-300 dark:border-gray-700 rounded-xl p-3.5 outline-none text-slate-900 dark:text-white focus:border-blue-600 transition-colors font-space text-sm md:text-base resize-none"></textarea>
                                        </div>
